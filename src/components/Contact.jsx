                ...
                <div className="grid grid-2" style={{ alignItems: 'center', backgroundColor: '#f8fafc', padding: '50px', borderRadius: '16px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)' }}>
                    <div>
                        ...
                        <ul className="contact-info" style={{ listStyle: 'none', padding: 0 }}>
                            <li style={{ display: 'flex', marginBottom: '15px' }}><span style={{ marginRight: '15px', fontSize: '1.5rem' }}>📍</span> <span><strong>Địa chỉ:</strong> 122/118, KP. Tân Lập, P. Đông Hòa, TP. Hồ Chí Minh</span></li>
                            <li style={{ display: 'flex', marginBottom: '15px' }}><span style={{ marginRight: '15px', fontSize: '1.5rem' }}>🏢</span> <span><strong>Trụ sở:</strong> Milano ML127 KĐT Ecocity Premia, P. Tân An, Đắk Lắk</span></li>
